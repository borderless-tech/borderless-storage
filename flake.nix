  ...
  outputs = { self, nixpkgs, rust-overlay, flake-utils, ... }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        borderlessPkg = pkgs.rustPlatform.buildRustPackage {
          ...
          meta = with lib; {
            description =
              "A minimal S3-style object store with pre-signed URLs and chunked uploads (Axum/Tokio).";
        ...
        dockerImage = pkgs.dockerTools.buildLayeredImage {
          ...
          contents = [ borderlessPkg pkgs.cacert ];
          ...
          config = {
            ...
            Env = [ "DATA_DIR=/data" "IP_ADDR=0.0.0.0:8080" ];
